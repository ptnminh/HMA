...
export enum PatientReceptionCommand {
  ...
  CREATE_MEDICAL_RECORD_USING_SUPPLIES = 'CREATE_MEDICAL_RECORD_USING_SUPPLIES',
  UPDATE_MEDICAL_RECORD_USING_SUPPLIES = 'UPDATE_MEDICAL_RECORD_USING_SUPPLIES',
}
...
export enum ClinicStatiticsCommand {
  ...
  GET_ADMIN_STATITICS = 'get-admin-statitics',
}
